...
#define JWRITE_STACK_DEPTH	5            	//Maximum nesting depth of JSON
...
//
char *jwErrorToString(unsigned char err);
...
void jwOpen(struct jWriteControl *jwc, char *buffer, unsigned short int buflen, enum jwNodeType rootType, unsigned char isPretty);
